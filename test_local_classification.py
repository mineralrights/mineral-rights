#!/usr/bin/env python3
"""
Local test to verify multi-deed classification works end-to-end
"""
...
def test_local_classification():
    """Test the complete classification pipeline locally"""
    
    print("🧪 LOCAL CLASSIFICATION TEST")
    print("=" * 50)
...
if __name__ == "__main__":
    success = test_local_classification()
    if success:
        print(f"\n✅ LOCAL TEST PASSED - Classification is working!")
    else:
        print(f"\n❌ LOCAL TEST FAILED - Need to fix issues first")
        sys.exit(1)
