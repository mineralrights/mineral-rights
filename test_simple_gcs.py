#!/usr/bin/env python3
"""
Simple GCS test with the provided credentials
"""
import base64
import json
import os
...
def test_gcs_with_temp_file():
    """Test GCS using temporary credentials file"""
    print("🔍 Testing GCS with temporary credentials file...")
...
if __name__ == "__main__":
    success = test_gcs_with_temp_file()
    if success:
        print("\n🎉 GCS test PASSED")
    else:
        print("\n💥 GCS test FAILED")
